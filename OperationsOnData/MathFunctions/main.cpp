...
//It's like asking to which should we elevate 2 to get eight?
//log by default computes the log in base e. 
//There is a another function which uses base 10 called log10

//Try the reverse operation of e^4 = 54.59, it will be log 54.59 in base e = ? //4

std::cout << "Log to get 54.59, you would elevate e to the power of : " << std::log(54.59) << std::endl;

//log10, 10^4 = 10000, to get 10k, you'd need to elevate 10 to the power of ? this is log in base10
...
//round : Halfway points are rounded away from 0. Eg: .5 and above are rounded up. the rest are rounded down.
//7.5 is rounded to 3, while 7.4999999 is rounded to 2
